...
parser.add_argument("--num_classes", type=int, default=, help="output channel of network")
parser.add_argument("--output_dir", type=str, default="./model_out", help="output dir")
parser.add_argument("--max_epochs", type=int, default= help="maximum epoch number to train")
parser.add_argument("--batch_size", type=int, default=, help="batch_size per gpu")
parser.add_argument("--eval_interval", type=int, default=, help="eval_interval")
parser.add_argument("--model_name", type=str, default=" ", help="model_name")
parser.add_argument("--img_size", type=int, default=, help="input patch size of network input")
parser.add_argument(
    "--cache-mode",
    type=str,
    default="part",
